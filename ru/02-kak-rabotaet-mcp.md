...
Теперь, когда мы разобрались с архитектурой и протоколом, пора перейти к практике. В следующей части мы рассмотрим два сквозных сценария из банковского ретейла — ручное расследование саппорта и автоматическую реакцию на алёрт, — а затем напишем работающий MCP-сервер на Spring Boot.
